...
class AlbertEntityEncoder(nn.Module):
    def __init__(self, max_length, pretrain_path, blank_padding=True, mask_entity=False, from_scratch=False):
        """
        Args:
        ...
        if from_scratch:
            config=AlbertConfig.from_json_file(pretrain_path)
